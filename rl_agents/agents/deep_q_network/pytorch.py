...
class DQNAgent(AbstractDQNAgent):
    def __init__(self, env, config=None):
        ...
        # print(trainable_parameters(self.value_net.ego_embedding))
        # print(trainable_parameters(self.value_net.attention_layer))
        # print(trainable_parameters(self.value_net.output_layer))
        # print(trainable_parameters(self.value_net))
